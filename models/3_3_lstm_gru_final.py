...
full_data = pd.read_csv('../data/AAPL_stock_data_with_indicators.csv', index_col='Date')
train_data = pd.read_csv('../data/AAPL_stock_data_train.csv', index_col='Date')
val_data = pd.read_csv('../data/AAPL_stock_data_val.csv', index_col='Date')
