...
try:
    ...
    full_data = pd.read_csv("../data/AAPL_stock_data_with_indicators.csv", index_col=0, parse_dates=True)
    ...
    train_data = pd.read_csv("../data/AAPL_stock_data_train.csv", index_col=0, parse_dates=True)
    val_data = pd.read_csv("../data/AAPL_stock_data_val.csv", index_col=0, parse_dates=True)
